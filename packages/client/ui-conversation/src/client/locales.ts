...
export const zh = {
  ...
  'stats.ttftAverage': '首tok {duration}',
  'stats.tokensPerSecond': '{throughput}',
  'stats.tokensPerSecondLive': '{throughput} tok/s',
  'stats.tpsTitle': '解码速度（最近统计窗口）',
  'stats.cacheHit': '缓存 {percent}%',
...
export const en = {
  ...
  'placeholder.model': 'Message {model}',
  ...
  'stats.tokensPerSecondLive': '{throughput} tok/s',
  'stats.tpsTitle': 'Decode speed (latest stats window)',
