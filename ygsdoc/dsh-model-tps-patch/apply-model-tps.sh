#!/usr/bin/env bash
# ==============================================================================
# apply-model-tps.sh — 一键应用「模型名占位符 + TPS 徽标 + 菜单宽度/层级」四项改动
# 位置：ygsdoc/dsh-model-tps-patch/apply-model-tps.sh
# 补丁：model-tps-sidebar-z-20260821.patch（9 个文件，405 行）
# ==============================================================================
#
# 【背景】
# 2026-08-21 对仓库源码（非 node_modules）做了以下改动。升级 dsh 后源码被覆盖，
# 用本脚本重新应用，然后重建产物。
#
# 【四项改动】
# 1) 输入框占位符显示当前模型名
...
# 3) 模型选择菜单宽度上限 min(420px, 50vw, 100vw-32px)
